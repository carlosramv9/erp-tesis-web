...
import { getUsersAction, setCurrentUserAction } from '../../store/actions/usersAction';
...
const UsersHeader = () => {
    ...
    const totalItems = useSelector(state => state.users.total)
    ...
    useEffect(() => {
        dispatch(getUsersAction(page, search, role));
